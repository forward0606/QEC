...
void set_default_setting(map<string, double> &default_setting){
...
int main(){
    ...
    set_default_setting(default_setting);
    cout<<default_setting["num_of_node"]<<endl;
    ...
    vector<string> X_names = {"num_of_node", "min_fidelity", "new_request_cnt"};//, "area_alpha", "resource_ratio", "entangle_alpha", "swap_prob"};
    ...
    vector<string> algo_names = {"MyAlgo", "MyAlgo2", "MyGreedyAlgo"};
